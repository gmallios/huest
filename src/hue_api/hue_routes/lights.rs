...
#[get("/{uid}/lights")]
pub async fn get_all_lights(uid: web::Path<String>, api_state: SharedController) -> impl Responder {
    // Sample Response:
    // {
    //     "1": {
    //             "state": {
...
#[get("/{uid}/lights/new")]
pub async fn get_new_lights(uid: web::Path<String>, api_state: SharedController) -> impl Responder {
    // Sample Response:
    // {
    //     "7": {"name": "Hue Lamp 7"},
    //     "8": {"name": "Hue Lamp 8"},
